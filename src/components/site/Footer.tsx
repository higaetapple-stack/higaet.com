      ...
      <Container className="px-0">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 mb-24">
          <div className="col-span-1">
            <Link to="/" className="font-display font-semibold text-xl tracking-tight block mb-6 text-ink">
              HIGAET
            </Link>
        ...
        <div className="pt-8 border-t border-border/60 flex flex-col md:flex-row justify-between gap-4">
          <span className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} Helen Institute of Gen AI Engineering &amp; Technology. All rights reserved.
          </span>
