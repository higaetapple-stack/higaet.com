...
export const Route = createFileRoute("/_authenticated/ops")({
  beforeLoad: ({ location }) =>
    requireRolesOrRedirect(ROUTE_PERMISSIONS["/ops"], { location }),
  component: OpsLayout,
});

const TABS = [{ to: "/ops/reliability", label: "Reliability" }];
...
function OpsLayout() {
  ...
  return (
    <div className="max-w-7xl">
      <div className="mb-6">
        <h1 className="font-display text-2xl font-medium text-ink">Platform Operations</h1>
        <p className="text-sm text-muted-foreground mt-1">
          Single-pane-of-glass for autonomous CI/CD, governance, and incident state.
        </p>
      </div>
