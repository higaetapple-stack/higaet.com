...
export const PROGRAMS: Program[] = [
  ...
  },
  {
    ...
    tagline: "Design, build, and operate autonomous multi-agent systems for real workflows.",
    category: "ai",
    level: "Career Track",
    duration: "9 months",
    format: "Hybrid",
    startDate: "Next cohort: 19 October 2026",
    feeINR: "₹2,85,000",
    emiFromINR: "₹8,600/mo",
    eligibility: ["Bachelor's degree", "Working Python knowledge", "Comfort with APIs and JSON"],
    outcomes: [
      "Architect tool-using agents with reliable planning and recovery",
      "Integrate MCP, function-calling, and memory stores",
      "Ship multi-agent orchestrations that survive production traffic",
  ...
  },
  {
    ...
    tagline: "Automate business workflows with LLMs, n8n, and event-driven pipelines.",
    category: "ai",
    level: "Career Track",
    duration: "6 months",
    format: "Online",
    ...
    outcomes: [
      ...
      "Apply LLMs to extraction, classification, and routing",
  ...
  },
  {
    ...
    tagline: "Treat prompts as engineering artifacts — versioned, evaluated, and shipped.",
    category: "ai",
    level: "Foundation",
    duration: "10 weeks",
    format: "Online",
    ...
    feeINR: "₹55,000",
    emiFromINR: "₹1,900/mo",
    eligibility: ["Any background; non-engineers welcome"],
    outcomes: [
      "Design prompts with measurable success criteria",
      "Build prompt evaluation harnesses",
      "Apply structured outputs, tool calls, and chaining",
  ...
  },
  {
    ...
    tagline: "Web + AI: ship modern full-stack apps with LLM features baked in.",
    category: "engineering",
    level: "Career Track",
    duration: "10 months",
    format: "Hybrid",
    startDate: "Next cohort: 26 October 2026",
    feeINR: "₹2,65,000",
    emiFromINR: "₹8,000/mo",
    eligibility: ["Bachelor's degree", "Basic programming exposure"],
    outcomes: [
      "Build production-grade full-stack apps with TypeScript",
      "Integrate LLM features (RAG, agents, structured outputs) end-to-end",
      "Apply auth, payments, and observability the way real teams do",
