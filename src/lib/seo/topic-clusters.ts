...
export const TOPIC_CLUSTERS: Record<ClusterId, TopicCluster> = {
  ...
  "academy-campuses-formats": {
    ...
    spokes: [
      { path: "/academy/campuses/bengaluru-campus", anchor: "HIGAET Bengaluru campus", blurb: "Industry diploma delivered at the Bengaluru campus." },
      { path: "/academy/campuses/hyderabad-campus", anchor: "HIGAET Hyderabad campus", blurb: "Industry diploma delivered at the Hyderabad campus." },
      { path: "/academy/learning-modes/blended", anchor: "blended learning mode", blurb: "Mix of on-campus residencies and online modules." },
      { path: "/academy/learning-modes/hybrid", anchor: "hybrid learning mode", blurb: "Hybrid online + campus learning experience." },
      { path: "/academy/learning-modes/online", anchor: "fully online learning mode", blurb: "End-to-end online cohort delivery." },
      { path: "/academy/learning-modes/on-campus", anchor: "on-campus learning mode", blurb: "Residential on-campus program format." },
    ],
