...
export const TOPIC_CLUSTERS: Record<ClusterId, TopicCluster> = {
  ...
  "academy-campuses-formats": {
    ...
    spokes: [
      { path: "/academy/campuses/higaet-bengaluru", anchor: "HIGAET Bengaluru campus", blurb: "Industry diploma delivered at the Bengaluru campus." },
      { path: "/academy/campuses/higaet-hyderabad", anchor: "HIGAET Hyderabad campus", blurb: "Industry diploma delivered at the Hyderabad campus." },
  ...
  "global-visa-funding": {
    ...
    spokes: [
      ...
      { path: "/global-education/knowledge-base/universities", anchor: "university knowledge base", blurb: "University-specific visa and admission notes." },
      { path: "/global-education/countries/usa", anchor: "USA student visa pathway", blurb: "Visa rules and timelines for the United States." },
      { path: "/global-education/countries/uk", anchor: "UK student visa pathway", blurb: "Visa rules and timelines for the United Kingdom." },
      { path: "/global-education/countries/canada", anchor: "Canada student visa pathway", blurb: "Visa rules and timelines for Canada." },
    ],
