...
export const TOPIC_CLUSTERS: Record<ClusterId, TopicCluster> = {
  ...
  "academy-genai-engineering": {
    ...
    spokes: [
      ...
      { path: "/academy/blog", anchor: "Academy blog & guides", blurb: "Articles on Gen AI engineering, learning, and careers." },
      { path: "/academy/scholarship", anchor: "Academy scholarship program", blurb: "Funding for eligible Academy learners." },
    ],
