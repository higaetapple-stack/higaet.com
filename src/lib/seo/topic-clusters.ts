...
export const TOPIC_CLUSTERS: Record<ClusterId, TopicCluster> = {
  ...
  "academy-campuses-formats": {
    ...
    spokes: [
      { path: "/academy/online-courses", anchor: "online cohort delivery", blurb: "Live online and self-paced formats." },
      { path: "/academy/offline-training", anchor: "in-person campus training", blurb: "Hands-on classroom and lab time." },
      { path: "/academy/learning-paths", anchor: "structured learning paths", blurb: "Sequenced tracks across formats." },
      { path: "/academy/corporate-training", anchor: "private cohorts for companies", blurb: "Closed cohorts at client or HIGAET sites." },
      { path: "/academy/admissions", anchor: "admissions across all campuses", blurb: "Per-campus intake details." },
      { path: "/academy/faq", anchor: "format & campus FAQs", blurb: "Picking the right format for your goals." },
    ],
  ...
  "global-visa-funding": {
    ...
    spokes: [
      ...
      { path: "/global-education/admission-process", anchor: "admissions to visa handoff", blurb: "How admissions and visa work together." },
      { path: "/global-education/student-services", anchor: "post-visa student services", blurb: "Onboarding once your visa is granted." },
      { path: "/global-education/countries", anchor: "visa rules by country", blurb: "Visa pathways for each destination." },
      { path: "/global-education/universities", anchor: "university-specific visa support", blurb: "Visa nuances per partner institution." },
      { path: "/global-education/faq", anchor: "visa & funding FAQs", blurb: "Most common visa and funding questions." },
    ],
  ...
  "tech-industry-solutions": {
    ...
    spokes: [
      ...
      { path: "/technologies/ai-solutions", anchor: "applied AI solutions", blurb: "Examples of deployed AI systems." },
      { path: "/technologies/digital-marketing", anchor: "AI-powered digital marketing", blurb: "MarTech and growth engineering." },
      { path: "/technologies/digital-transformation", anchor: "digital transformation programs", blurb: "Cross-functional transformation work." },
